...
<head>
  ...
  <title>CampGo Destinations</title>
  <!--Css link-->
...
<div class="container">
  <div class="list-container">
    <div class="left-col">
      <p>100+ Options</p>
      <h1>Destinations Around Sri Lanka</h1>
      ...
      <div class="camp">
        ...
        <div class="camp-info">
        <p><i class="fas fa-map-marker-alt"></i> <b><?php echo $row["des_location"]; ?></b></p>
          ...
          <div class="price">
            <h4><?php echo $row["des_price"]; ?><span>/ per person</span></h4>
            <button class="btn btn-primary">Check Availability</button><br>
            <button class="btn btn-primary"><a href="./DestinationInfo.php"><< View More >></a></button>
          </div>
        </div>
      </div>
